...
import { InvokerAction, buildInvokerActionRollup } from '../../util'
...
describe('MultiInvokerRollup', () => {
  ...
  describe('#invoke', () => {
    ...
    it('deposits on DEPOSIT action', async () => {
      console.log('pld: ', actions.DEPOSIT.payload)
    ...
    //     console.log("withdraw payload: ", "0x"+actions.WITHDRAW.payload)
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WITHDRAW.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.OPEN_TAKE.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.CLOSE_TAKE.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.OPEN_MAKE.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.CLOSE_MAKE.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.CLAIM.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WRAP.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.UNWRAP.payload))
    ...
    //   const res = user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WRAP_AND_DEPOSIT.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WRAP_AND_DEPOSIT.payload))
    ...
    //   const res = await user.sendTransaction(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WITHDRAW_AND_UNWRAP.payload))
    ...
    //   const res = await user.call(buildTransactionRequest(user, multiInvokerRollup, "0x"+actions.WITHDRAW_AND_UNWRAP.payload))
    ...
    //   await expect(multiInvokerR.connect(user).invoke(Object.values(actions))).to.not.be.reverted
  ...
  context('batcher address is 0', () => {
    ...
    //   beforeEach(() => {
    //     actions = buildInvokerActionRollup(BigNumber.from(0), BigNumber.from(0), product.address, position, amount, programs)
    //     dsu.transferFrom.whenCalledWith(user.address, multiInvokerRollup.address, amount).returns(true)
    //     usdc.transferFrom.whenCalledWith(user.address, multiInvokerRollup.address, usdcAmount).returns(true)
    //     usdc.transfer.whenCalledWith(user.address, usdcAmount).returns(true)
    //   })
