...
interface IParamProvider {
    ...
    error ParamProviderInvalidPositionFeeShare();
    ...
    function positionFeeShare() external view returns (UFixed18);
    function updatePositionFeeShare(UFixed18 newPositionFeeShare) external;
